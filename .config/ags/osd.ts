...
function mute() {
    ...
    return rev
        .hook(audio.microphone, () => {
            ico.icon = audio.microphone.is_muted ? icons.audio.mic.muted : icons.audio.mic.unmuted
            rev.reveal_child = true
            count++
            Utils.timeout(DELAY, () => {
                count--
        ...
        .hook(audio.speaker, () => {
            ico.icon = audio.speaker.is_muted ? icons.audio.volume.muted : icons.audio.volume.low
            rev.reveal_child = true
            count++
            Utils.timeout(DELAY, () => {
                count--
