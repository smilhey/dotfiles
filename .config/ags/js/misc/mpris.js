...
export const ColoredBox = (player, { ...props }) =>
  Widget.Box({
    ...props,
    connections: [
      [
...
export const FontColoredBox = (player, { ...props }) =>
  Widget.Box({
    ...props,
    connections: [
      [
  ...
  Widget.Box({
    ...
    binds: [
      [
        ...
        "cover-path",
        (path) =>
          `background: url("${path}"); background-size: cover; background-position: center;`,
      ],
    ],
  });

export const MaterialCoverArt = (player, props) =>
  Widget.CenterBox({
    ...props,
    connections: [
      [
